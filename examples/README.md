...
| `<mol>_CLPO_E2.txt` | `--e2` | pair-interaction table: E2 (kcal/mol) + charge transfer q (e); CLPO rows grouped by acceptor class (NB first, then RY); any other set runs the same way |
