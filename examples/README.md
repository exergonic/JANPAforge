...
| `<mol>_CLPO_E2.txt` | `--e2` | pair-interaction table: charge transfer q (e) + E2 (kcal/mol); CLPO rows grouped by acceptor class (NB first, then RY); any other set runs the same way |
